...
public class ReservationController {
	...
	public ResponseEntity<List<Reservation>>  getByDateController(@PathVariable("date") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date ) throws ReservationException{
